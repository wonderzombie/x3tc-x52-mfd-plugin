...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure InitLeds(PageNumber : integer);      // Workaround for DirectOutput.dll bug: unless all LEDs are filled up with 1's once they are ignoring turn off command...
